...
slist_naryad = ['НомНар','ТабНомВод','ФИОвод','ГосНомАвто','НомВодУдост']
slist_pl = ['НомПутЛист','ДатаСостПЛ','ТабНомВод','НомВодУдост','ГосНомАвто']
...
searhListINT = ["Цена", "Количество", "Стоим",
...
searhList = ['КодГСМ','НазвГСМ','ЕдИзм',
             ...
             'ДатПЛ','НомСкл','НомЦист','ДатСостКСУ']
searhSQLList = {
