...
list_typegsm = ['Код ГСМ', 'Название ГСМ', 'Единица измерения','Марка ГСМ']
...
slist_typegsm = ['КодГСМ','НазвГСМ','ЕдИзм','МаркГСМ']
...
searhList = ['КодГСМ','НазвГСМ','ЕдИзм','МаркГСМ',
